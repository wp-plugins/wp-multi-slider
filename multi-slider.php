...
class MetaSliderPlugin {
    ...
    private function define_constants() {
        ...
        define( 'METASLIDER_BASE_URL',   trailingslashit( plugins_url( 'multi-slider' ) ) );
    ...
    public function register_admin_menu() {
        ...
        $title = apply_filters( 'metaslider_menu_title', 'Multi Slider' );
    ...
    public function go_pro_page() {
        $hide_link = '<a href="' . admin_url( "admin-post.php?action=metaslider_hide_go_pro_page" ) . '"></a>';
        ...
        $gopro_link = "<a class='button button-primary' href='{$link}' target='_blank'></a>";
        $support_link = '<a href="https://wordpress.org/support/plugin/ml-slider"></a>';
        $documentation_link = '<a href="http://www.metaslider.com/documentation/"></a>';
    ...
    public function help_tab() {
        ...
        $screen->add_help_tab( array(
                'id'    => '',
                'title' => __( '', 'metaslider' ),
                'content'   => "<p><a href='http://www.metaslider.com/documentation/' target='blank'></a></p>",
            )
        );
                                                ...
                                                <?php
                                                    $aFields = array(
                                                        'type' => array(
                                                            ...
                                                            'options' => array(
                                                                'flex'       => array( 'label' => __( "Slider one", "metaslider" ) ),
                                                                'responsive' => array( 'label' => __( "Slider two", "metaslider" ) ),
                                                                'nivo'       => array( 'label' => __( "Slider three", "metaslider" ) ),
                                                                'coin'       => array( 'label' => __( "Slider four", "metaslider" ) )
                                                            )
                                                        ),
                                                        'width' => array(
                                                            'priority' => 10,
    ...
    public function upgrade_to_pro_link( $links ) {
        ...
        if ( function_exists( 'is_plugin_active' ) && ! is_plugin_active( 'ml-slider-pro/ml-slider-pro.php' ) ) {
            $links[] = '<a href="http://www.metaslider.com/upgrade" target="_blank">' . __( "", "metaslider" ) . '</a>';
        }
